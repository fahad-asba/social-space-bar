      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div className="contact-grid">
          ...
          <div className="contact-form-col">
            <ContactForm title="Start your social media marketing Today" subtitle="Claim 30% Off Today" description="Fill in your details and we'll create a custom social media marketing plan for your brand." />
          </div>
        </div>
      </div>
