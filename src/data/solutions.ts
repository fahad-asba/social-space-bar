...
export const offerings: SolutionOffering[] = [
  ...
  { icon: '\u{1F680}', title: 'Campaign Launches', desc: 'High-impact launches that create instant buzz' },
  { icon: '\u{1F3AC}', title: 'Ad Creatives', desc: 'Cinematic ads that captivate your audience' },
  { icon: '\u{1F4BB}', title: 'Brand Website', desc: 'Professional websites that establish your brand' },
];
